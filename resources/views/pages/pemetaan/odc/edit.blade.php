...
@section('content')
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                {!! Form::model($perangkat, ['route' => ['pemetaan-odc.update', $perangkat->id], 'method' => 'put', 'files' => true]) !!}
                    <div class="form-group">
                        <label for="">ODC</label>
                        {!! Form::text('id_odc', $perangkat->nama_odc, ['id' => 'id_odc', 'disabled' => 'disabled', 'class' => $errors->has('odc') ? 'form-control is-invalid' : 'form-control']) !!}
                        @error('odc')
