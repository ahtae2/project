...
@section('content')
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                {!! Form::open(['route' => 'pemetaan-odc.store', 'method' => 'post', 'files' => true]) !!}
                    <div class="form-group">
                        <label for="">Perangkat ODC</label>
                        <select class="form-control" id="odc" name="id_odc" style="width: 100%;">
                        @if(!$perangkat->first())
                            <option value="">--Perangkat ODC Tidak Tersedia--</option>
                        @endif
