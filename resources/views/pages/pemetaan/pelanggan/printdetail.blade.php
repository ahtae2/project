    ...
    <div class="container">
        <div class="row">
            <div class="col-12  mt-5">
                ...
                <h3 class="text-center"><b>Data Pemetaan Pelanggan</b></h3>
                <h6 class="text-center">PT Radmila Pratama Multireka</h6><br>
                <p>Tanggal Laporan: {{ Carbon\Carbon::now()->format('Y-m-d') }}</p>
                <div class="card">
                    <div class="card-header">
                        <h6 class="card-title mt-2 font-weight-bold">Detail Pelanggan</h6>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-left">ID Pemetaan</label>
                            <div class="col-sm-8">
                                <p class="form-control border-0 my-0">{{ $pemetaanPelanggan->id }}</p>
                            </div>
                        </div><hr>
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-left">Tanggal Pemetaan</label>
                            <div class="col-sm-8">
                                <p class="form-control border-0 my-0">{{ $pemetaanPelanggan->created_at }}</p>
                            </div>
                        </div><hr>
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-left">Nama</label>
                            <div class="col-sm-8">
                                <p class="form-control border-0 my-0">{{ $pemetaanPelanggan->nama }}</p>
                            </div>
                        </div><hr>
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-left">Alamat Pemetaan</label>
                            <div class="col-sm-8">
                                <p class="form-control border-0 my-0">{{ $pemetaanPelanggan->alamat }}</p>
                            </div>
                        </div><hr>
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-left">Latitude</label>
                            <div class="col-sm-8">
                                <p class="form-control border-0 my-0">{{ $pemetaanPelanggan->latitude }}</p>
                            </div>
                        </div><hr>
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-left">Longitude</label>
                            <div class="col-sm-8">
                                <p class="form-control border-0 my-0">{{ $pemetaanPelanggan->longitude }}</p>
                            </div>
                        </div><hr>
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-left">Keterangan</label>
                            <div class="col-sm-8">
                                <p class="form-control border-0 my-0">{{ $pemetaanPelanggan->keterangan }}</p>
                            </div>
                        </div><hr>
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-left">Nama ODP</label>
                            <div class="col-sm-8">
                                <p class="form-control border-0 my-0">{{ $pemetaanPelanggan->nama_petaodp }}</p>
                            </div>
                        </div><hr>
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-left">Port</label>
                            <div class="col-sm-8">
                                <p class="form-control border-0 my-0">{{ $pemetaanPelanggan->port }}</p>
                            </div>
                        </div>
                    </div>
                </div>
