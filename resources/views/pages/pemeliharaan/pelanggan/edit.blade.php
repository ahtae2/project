...
@section('content')
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                {!! Form::model($pemeliharaanPelanggan, ['route' => ['pemeliharaan-pelanggan.update', $pemeliharaanPelanggan->id], 'method' => 'put', 'files' => true]) !!}
                    <div class="form-group">
                        <label for="">Pelangan</label>
                        {!! Form::text('id_pelanggan', $pemeliharaanPelanggan->nama, ['id' => 'id_pelanggan', 'disabled' => 'disabled', 'class' => $errors->has('pelanggan') ? 'form-control is-invalid' : 'form-control']) !!}
                        @error('pelanggan')
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('keterangan', ['Lancar' => 'Lancar', 'Gangguan' => "Gangguan"], null, ['class' => $errors->has('keterangan') ? 'form-control is-invalid' : 'form-control']) !!}
                        @error('keterangan')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
