...
@section('content')
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                {!! Form::model($pemeliharaan, ['route' => ['pemeliharaan.update', $pemeliharaan->id], 'method' => 'put', 'files' => true]) !!}
                    <div class="form-group">
                        <label for="">Perangkat</label>
                        {!! Form::text('id_odc', $pemeliharaan->nama, ['id' => 'id_odc', 'disabled' => 'disabled', 'class' => $errors->has('odc') ? 'form-control is-invalid' : 'form-control']) !!}
                        @error('odc')
