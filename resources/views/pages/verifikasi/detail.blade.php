        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="button-title">
                    ...
                    @endif
                    @if (auth()->user()->role == 'admin')
                        {!! Form::open(['route' => ['verifikasi-pendaftaran.update', $pengguna->id], 'method' => 'put', 'class' => 'float-right pl-1']) !!}
                            <button type="submit" class="btn btn-success btn-sm"><i class="fas fa-check nav-icon"></i> Verifikasi</button>
                        {!! Form::close() !!}
                    @endif
                  </div>
              </div>
