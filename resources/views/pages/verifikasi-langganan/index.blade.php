...
<div class="col-12">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title mt-2 font-weight-bold">Tabel Verifikasi Pelanggan</h3>
              ...
              <tr>
                ...
                <td>                                       
                  <form action="{{ route('pelanggan.destroy', $value->id) }}" method="post">
                      ...
                      <a href="{{ route('pelanggan.verifikasi.verified', $value->id) }}" class="btn btn-success btn-sm"><i class="fas fa-check nav-icon"></i></a>
